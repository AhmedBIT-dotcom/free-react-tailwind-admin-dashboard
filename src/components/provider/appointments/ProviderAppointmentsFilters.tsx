interface ProviderAppointmentsFiltersProps {
  isRtl: boolean;
}

export default function ProviderAppointmentsFilters({ isRtl }: ProviderAppointmentsFiltersProps) {
  return (
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5 items-end">
        ...
        <div className="lg:col-span-1">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={isRtl ? "البحث عن موعد..." : "Search appointments..."}
        ...
        <div className="lg:col-span-1">
          ...
          <select className="w-full rounded-lg border border-gray-200 bg-transparent py-2.5 px-4 text-sm text-gray-800 outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 appearance-none">
            ...
            <option value="clean">{isRtl ? "تنظيف المنازل" : "Home Cleaning"}</option>
          </select>
        </div>
        ...
        <div className="lg:col-span-1">
          ...
          <select className="w-full rounded-lg border border-gray-200 bg-transparent py-2.5 px-4 text-sm text-gray-800 outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 appearance-none">
            ...
            <option value="4">خالد حسن</option>
            <option value="5">فاطمة أحمد</option>
          </select>
        </div>
